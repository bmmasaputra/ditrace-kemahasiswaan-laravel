...
class ProvinsiNDB
{
    ...
    {
        return collect(self::$provinsi);
    }

    public static function options(): array
    {
        // For Filament Select: [id_prov => provinsi]
        return collect(self::$provinsi)->mapWithKeys(
            fn($o) => [$o->id_prov => $o->provinsi]
        )->toArray();
    }
}
